...
test.describe('healthcare - medical_office Tests', () => {
  ...
  test('Medical Office Manchester - Cost Calculation', async ({ page }) => {
    ...
    await descriptionInput.fill('45000 sf medical office building in Manchester NH');
