...
test.describe('educational - school Tests', () => {
  ...
  test('Middle School Bedford - Cost Calculation', async ({ page }) => {
    ...
    await descriptionInput.fill('65000 sf middle school for 800 students in Bedford NH');
