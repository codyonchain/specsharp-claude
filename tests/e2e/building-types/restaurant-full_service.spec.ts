...
test.describe('restaurant - full_service Tests', () => {
  ...
  test('Full Service Restaurant Franklin - Cost Calculation', async ({ page }) => {
    ...
    await descriptionInput.fill('4200 sf full-service restaurant with bar and patio in Franklin TN');
