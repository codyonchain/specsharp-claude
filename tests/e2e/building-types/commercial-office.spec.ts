...
test.describe('commercial - office Tests', () => {
  ...
  test('Class A Office Nashville - Cost Calculation', async ({ page }) => {
    ...
    await descriptionInput.fill('85000 sf Class A office tower with structured parking in Nashville');
