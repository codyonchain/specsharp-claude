...
test.describe('retail - shopping_center Tests', () => {
  ...
  test('Shopping Center Concord - Cost Calculation', async ({ page }) => {
    ...
    await descriptionInput.fill('35000 sf neighborhood shopping center with grocery anchor in Concord NH');
