        ...
        "trade_profiles": [
            {
                ...
                "items": [
                    ...
                    {
                        "key": "seismic_bracing_for_rack_rows",
                        "label": "Seismic Bracing for Rack Rows",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "key": "crah_units_and_hot_aisle_return",
                        "label": "CRAH Units + Hot Aisle Return",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.2},
                    },
                    {
                        "key": "condenser_water_pumping_and_treatment",
                        "label": "Condenser Water Pumping + Treatment",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.15},
                    },
                    {
                        "key": "economizer_relief_and_airside_controls",
                        "label": "Economizer Relief + Airside Controls",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
            ...
            },
            {
                ...
                "items": [
                    ...
                    },
                    {
                        ...
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.23},
                    },
                    {
                        "key": "busway_rack_power_taps",
                        "label": "Busway + Rack Power Taps",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.19},
                    },
                    {
                        "key": "battery_monitoring_and_dc_controls",
                        "label": "Battery Monitoring + DC Controls",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.16},
                    },
                    {
                        "key": "branch_circuit_monitoring_and_bms_points",
                        "label": "Branch Circuit Monitoring + BMS Points",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "key": "humidification_makeup_and_blowdown",
                        "label": "Humidification Makeup + Blowdown",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.22},
                    },
                ...
                "items": [
                    {
                        ...
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.4},
                    },
                    {
                    ...
                    {
                        "key": "antistatic_access_floor_finish_package",
                        "label": "Antistatic Access Floor Finish Package",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
        ...
        "trade_profiles": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "key": "vivarium_temperature_holdback",
                        "label": "Vivarium Temperature Holdback",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.28},
                    },
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "key": "clean_power_and_isolated_ground_receptacles",
                        "label": "Clean Power + Isolated Ground Receptacles",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.3},
                    },
                ],
            },
            {
                ...
                "items": [
                    ...
                    {
                        "key": "acid_waste_neutralization_and_trench_drain",
                        "label": "Acid Waste Neutralization + Trench Drain",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
        ...
        "trade_profiles": [
            {
                ...
                "items": [
                    ...
                    {
                        "key": "elevator_tower_and_corridor_reinforcing",
                        "label": "Elevator Tower + Corridor Reinforcing",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.28},
                    },
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "key": "dehumidification_for_climate_zones",
                        "label": "Dehumidification for Climate Zones",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.26},
                    },
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "key": "gate_operator_power_and_loop_detection",
                        "label": "Gate Operator Power + Loop Detection",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.28},
                    },
        ...
        "trade_profiles": [
            {
                ...
                "items": [
                    ...
                    {
                        "key": "vehicle_delivery_porch_and_ramp_reinforcing",
                        "label": "Vehicle Delivery Porch + Ramp Reinforcing",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.28},
                    },
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "key": "paint_booth_makeup_air_and_tempering",
                        "label": "Paint Booth Makeup Air + Tempering",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.26},
                    },
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "key": "ev_charger_switchboards_and_load_management",
                        "label": "EV Charger Switchboards + Load Management",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.3},
                    },
        ...
        "trade_profiles": [
            {
                ...
                "items": [
                    ...
                    {
                        "key": "catwalk_grids_and_rigging_support",
                        "label": "Catwalk Grids + Rigging Support",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.28},
                    },
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "key": "edit_suite_variable_refrigerant_flow",
                        "label": "Edit Suite Variable Refrigerant Flow",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.28},
                    },
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "key": "ups_for_master_control_and_routing_core",
                        "label": "UPS for Master Control + Routing Core",
                        "unit": "SF",
                        "quantity_rule": {"type": "sf"},
                        "allocation": {"type": "share_of_trade", "share": 0.3},
                    },
