    ...
    "healthcare_surgical_center_structural_v1": {
        "trade_profiles": [
            ...
            _trade(
                ...
                "Mechanical",
                [
                    _item(key="asc_or_ahus_and_pressurization", label="OR AHUs and pressure cascade controls", unit="LS", share=0.45, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="asc_sterile_core_hvac_distribution", label="Sterile-core HVAC distribution", unit="SF", share=0.30),
            ...
            _trade(
                ...
                "Electrical",
                [
                    _item(key="asc_isolated_power_and_panels", label="Isolated power and critical panels", unit="LS", share=0.40, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="asc_lighting_and_room_controls", label="Clinical lighting and room controls", unit="SF", share=0.35),
            ...
            _trade(
                ...
                "Plumbing",
                [
                    _item(key="asc_med_gas_backbone", label="Medical gas backbone and zone valves", unit="LS", share=0.40, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="asc_scrub_and_sterile_plumbing", label="Scrub sink and sterile-room plumbing", unit="SF", share=0.35),
    ...
    "healthcare_imaging_center_structural_v1": {
        "trade_profiles": [
            _trade(
                ...
                "Structural",
                [
                    _item(key="img_vibration_controlled_slab", label="Vibration-controlled modality slabs", unit="SF", share=0.40),
                    _item(key="img_rf_room_framing", label="RF room framing and envelope reinforcement", unit="SF", share=0.35),
                    _item(key="img_roof_and_screenwall_support", label="Roof support and equipment screenwalls", unit="SF", share=0.25),
                ],
            ),
            _trade(
                "mechanical",
                "Mechanical",
                [
                    _item(key="img_modality_cooling_loops", label="Modality cooling and dedicated loops", unit="LS", share=0.40, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="img_exam_suite_air_distribution", label="Exam-suite air distribution", unit="SF", share=0.35),
                    _item(key="img_temperature_humidity_controls", label="Tight temperature/humidity controls", unit="LS", share=0.25, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
            _trade(
                "electrical",
                "Electrical",
                [
                    _item(key="img_power_quality_mitigation", label="Power quality mitigation and filtering", unit="LS", share=0.45, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="img_modality_distribution_panels", label="Modality distribution and dedicated panels", unit="LS", share=0.30, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="img_control_room_low_voltage", label="Control-room low voltage and data", unit="SF", share=0.25),
                ],
            ),
            _trade(
                "plumbing",
                "Plumbing",
                [
                    _item(key="img_procedure_sink_groups", label="Procedure and prep sink groups", unit="EA", share=0.40, quantity_type="restroom_groups", quantity_params={"sf_per_group": 5000.0, "minimum": 1}),
                    _item(key="img_domestic_and_sanitary_distribution", label="Domestic and sanitary distribution", unit="SF", share=0.35),
                    _item(key="img_shielded_room_drainage", label="Shielded-room drainage tie-ins", unit="LS", share=0.25, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
            _trade(
                "finishes",
                "Finishes",
                [
                    _item(key="img_shielded_room_finishes", label="Shielded-room wall and door finish package", unit="SF", share=0.40),
                    _item(key="img_patient_corridor_finishes", label="Patient corridor and waiting finishes", unit="SF", share=0.35),
                    _item(key="img_control_room_casework", label="Control-room casework and consoles", unit="LS", share=0.25, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
        ],
    },
    "healthcare_urgent_care_structural_v1": {
        "trade_profiles": [
            _trade(
                ...
                "Structural",
                [
                    _item(key="uc_foundations_and_thickened_slab", label="Foundations and thickened slab zones", unit="SF", share=0.40),
                    _item(key="uc_clinic_shell_and_roof_frame", label="Clinic shell framing and roof deck", unit="SF", share=0.35),
                    _item(key="uc_canopy_and_entry_reinforcement", label="Ambulance/drop-off canopy reinforcement", unit="SF", share=0.25),
                ],
            ),
            _trade(
                "mechanical",
                "Mechanical",
                [
                    _item(key="uc_exam_suite_hvac", label="Exam-suite HVAC and outside-air package", unit="SF", share=0.40),
                    _item(key="uc_isolation_exhaust_allowance", label="Isolation and treatment exhaust allowance", unit="LS", share=0.35, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="uc_controls_and_afterhours_modes", label="After-hours controls and setback modes", unit="LS", share=0.25, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
            _trade(
                "electrical",
                "Electrical",
                [
                    _item(key="uc_service_and_branch_distribution", label="Main service and branch distribution", unit="LS", share=0.40, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="uc_treatment_and_triage_lighting", label="Triage/treatment lighting and controls", unit="SF", share=0.35),
                    _item(key="uc_imaging_and_lab_power_allowance", label="Imaging and in-house lab power allowance", unit="LS", share=0.25, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
            _trade(
                "plumbing",
                "Plumbing",
                [
                    _item(key="uc_domestic_and_sanitary", label="Domestic and sanitary plumbing distribution", unit="SF", share=0.40),
                    _item(key="uc_exam_sink_and_flush_groups", label="Exam-room sink and fixture groups", unit="EA", share=0.35, quantity_type="restroom_groups", quantity_params={"sf_per_group": 7000.0, "minimum": 1}),
                    _item(key="uc_lab_and_specimen_waste", label="Lab/specimen waste and cleanout allowances", unit="LS", share=0.25, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
            _trade(
                "finishes",
                "Finishes",
                [
                    _item(key="uc_clinical_wall_and_ceiling_systems", label="Clinical wall and ceiling systems", unit="SF", share=0.40),
                    _item(key="uc_high_turnover_flooring", label="High-turnover flooring and wall protection", unit="SF", share=0.35),
                    _item(key="uc_reception_casework_and_triage", label="Reception, triage, and charting casework", unit="LS", share=0.25, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
        ],
    },
    ...
    "healthcare_medical_office_building_structural_v1": {
        "trade_profiles": [
            _trade(
                ...
                "Structural",
                [
                    _item(key="mob_foundations_and_core", label="MOB foundations and core structure", unit="SF", share=0.40),
                    _item(key="mob_floor_framing_and_decks", label="Multi-floor framing and deck package", unit="SF", share=0.35),
                    _item(key="mob_shell_enclosure_support", label="Shell enclosure and canopy supports", unit="SF", share=0.25),
                ],
            ),
            _trade(
                "mechanical",
                "Mechanical",
                [
                    _item(key="mob_base_building_hvac", label="Base-building HVAC backbone", unit="SF", share=0.40),
                    _item(key="mob_tenant_ready_air_distribution", label="Tenant-ready air-distribution stubs", unit="SF", share=0.35),
                    _item(key="mob_future_specialty_capacity_allowance", label="Future specialty suite capacity allowance", unit="LS", share=0.25, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
            _trade(
                "electrical",
                "Electrical",
                [
                    _item(key="mob_service_switchgear_and_risers", label="Service switchgear and vertical risers", unit="LS", share=0.40, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="mob_common_area_lighting", label="Common-area and shell lighting", unit="SF", share=0.35),
                    _item(key="mob_tenant_metering_and_data", label="Tenant metering and data rough-in", unit="LS", share=0.25, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
            _trade(
                "plumbing",
                "Plumbing",
                [
                    _item(key="mob_domestic_and_sanitary_mains", label="Domestic/sanitary mains and branch tie-ins", unit="SF", share=0.40),
                    _item(key="mob_restroom_core_groups", label="Core restroom groups by floor", unit="EA", share=0.35, quantity_type="restroom_groups", quantity_params={"sf_per_group": 14000.0, "minimum": 1}),
                    _item(key="mob_future_wet_stack_allowance", label="Future wet-stack allowance for tenant suites", unit="LS", share=0.25, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
            _trade(
                "finishes",
                "Finishes",
                [
                    _item(key="mob_lobby_and_core_finishes", label="Lobby and core corridor finishes", unit="SF", share=0.40),
                    _item(key="mob_shell_corridor_protection", label="Shell corridor wall protection and paint", unit="SF", share=0.35),
                    _item(key="mob_public_toilet_casework", label="Public toilet and common-casework allowance", unit="LS", share=0.25, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
        ],
    },
    ...
    "healthcare_hospital_structural_v1": {
        "trade_profiles": [
            _trade(
                ...
                "Structural",
                [
                    _item(key="hosp_foundation_and_mat_packages", label="Tower mat foundations and podium structure", unit="SF", share=0.40),
                    _item(key="hosp_vertical_structure_and_core", label="Vertical frame and seismic core package", unit="SF", share=0.35),
            ...
            _trade(
                ...
                "Mechanical",
                [
                    _item(key="hosp_central_plant_and_redundant_ahus", label="Central plant and redundant AHU package", unit="LS", share=0.45, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="hosp_critical_care_air_distribution", label="Critical-care air distribution", unit="SF", share=0.30),
                    _item(key="hosp_isolation_and_exhaust_systems", label="Isolation, lab, and OR exhaust systems", unit="LS", share=0.25, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
            _trade(
                "electrical",
                "Electrical",
                [
                    _item(key="hosp_main_switchgear_and_feeders", label="Main switchgear and feeder redundancy", unit="LS", share=0.45, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="hosp_critical_branch_distribution", label="Critical branch distribution and ATS", unit="LS", share=0.30, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="hosp_clinical_lighting_and_controls", label="Clinical lighting, controls, and nurse call", unit="SF", share=0.25),
                ],
            ),
            _trade(
                "plumbing",
                "Plumbing",
                [
                    _item(key="hosp_med_gas_and_vacuum", label="Medical gas, vacuum, and alarm panels", unit="LS", share=0.45, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="hosp_domestic_and_sanitary_risers", label="Domestic/sanitary risers and branch networks", unit="SF", share=0.30),
            ...
            _trade(
                ...
                "Finishes",
                [
                    _item(key="hosp_clinical_wall_and_ceiling_systems", label="Clinical wall and ceiling system package", unit="SF", share=0.40),
                    _item(key="hosp_patient_room_finish_package", label="Patient room finish package", unit="SF", share=0.35),
    ...
    "healthcare_medical_center_structural_v1": {
        "trade_profiles": [
            _trade(
                ...
                "Structural",
                [
                    _item(key="mc_foundation_and_podium", label="Medical-center foundation and podium package", unit="SF", share=0.40),
                    _item(key="mc_multiwing_structure", label="Multi-wing structural frame", unit="SF", share=0.35),
            ...
            _trade(
                ...
                "Mechanical",
                [
                    _item(key="mc_main_hvac_and_airside", label="Main HVAC and airside distribution", unit="SF", share=0.45),
                    _item(key="mc_specialty_suite_ventilation", label="Specialty-suite ventilation package", unit="LS", share=0.30, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="mc_controls_and_analytics", label="Building controls and analytics integration", unit="LS", share=0.25, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
            _trade(
                "electrical",
                "Electrical",
                [
                    _item(key="mc_switchgear_and_vertical_distribution", label="Switchgear and vertical distribution", unit="LS", share=0.45, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="mc_service_line_power_buildout", label="Service-line power buildout", unit="LS", share=0.30, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="mc_low_voltage_and_monitoring", label="Low-voltage and clinical monitoring tie-ins", unit="SF", share=0.25),
                ],
            ),
            _trade(
                "plumbing",
                "Plumbing",
                [
                    _item(key="mc_medical_and_domestic_piping", label="Medical/domestic piping backbone", unit="SF", share=0.40),
                    _item(key="mc_multi_suite_fixture_groups", label="Multi-suite fixture groups", unit="EA", share=0.35, quantity_type="restroom_groups", quantity_params={"sf_per_group": 12000.0, "minimum": 1}),
            ...
            _trade(
                ...
                "Finishes",
                [
                    _item(key="mc_public_clinical_finishes", label="Public and clinical-area finish package", unit="SF", share=0.40),
                    _item(key="mc_specialty_suite_finishes", label="Specialty-suite finish upgrades", unit="SF", share=0.35),
