    ...
    "healthcare_imaging_center_structural_v1": {
        "trade_profiles": [
            ...
            _trade(
                ...
                "Mechanical",
                [
                    _item(key="img_modality_cooling_loops", label="Modality cooling and dedicated loops", unit="LS", share=0.30, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="img_exam_suite_air_distribution", label="Exam-suite air distribution", unit="SF", share=0.25),
                    ...
                    _item(key="img_mri_quench_and_relief_air_path", label="MRI quench and relief air-path allowances", unit="LS", share=0.20, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
            _trade(
                "electrical",
                "Electrical",
                [
                    _item(key="img_power_quality_mitigation", label="Power quality mitigation and filtering", unit="LS", share=0.30, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="img_modality_distribution_panels", label="Modality distribution and dedicated panels", unit="LS", share=0.25, quantity_type="constant", quantity_params={"value": 1}),
                    _item(key="img_control_room_low_voltage", label="Control-room low voltage and data", unit="SF", share=0.25),
                    _item(key="img_equipment_grounding_and_shield_bonding", label="Equipment grounding and RF shield bonding", unit="LS", share=0.20, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
            _trade(
                "plumbing",
                "Plumbing",
                [
                    _item(key="img_procedure_sink_groups", label="Procedure and prep sink groups", unit="EA", share=0.30, quantity_type="restroom_groups", quantity_params={"sf_per_group": 5000.0, "minimum": 1}),
                    _item(key="img_domestic_and_sanitary_distribution", label="Domestic and sanitary distribution", unit="SF", share=0.25),
                    ...
                    _item(key="img_process_cooling_water_isolation", label="Process cooling-water isolation and bypass", unit="LS", share=0.20, quantity_type="constant", quantity_params={"value": 1}),
                ],
            ),
            _trade(
                "finishes",
