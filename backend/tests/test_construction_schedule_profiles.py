...
TARGET_SUBTYPE_EXPECTATIONS = [
    ...
    (BuildingType.MIXED_USE, "office_residential", 31),
    (BuildingType.MIXED_USE, "retail_residential", 28),
    (BuildingType.MIXED_USE, "hotel_retail", 30),
    (BuildingType.MIXED_USE, "transit_oriented", 33),
    (BuildingType.MIXED_USE, "urban_mixed", 32),
    ...
    (BuildingType.CIVIC, "library", 21),
    (BuildingType.CIVIC, "courthouse", 30),
    (BuildingType.CIVIC, "government_building", 24),
    (BuildingType.CIVIC, "community_center", 20),
    (BuildingType.CIVIC, "public_safety", 22),
    (BuildingType.RECREATION, "fitness_center", 16),
    (BuildingType.RECREATION, "sports_complex", 24),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (BuildingType.MIXED_USE, "unknown_mixed_use_variant", 30),
